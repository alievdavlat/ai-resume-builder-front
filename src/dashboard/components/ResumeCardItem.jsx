...
function ResumeCardItem({ resume, refreshData }) {
  ...
  return (
    <div className="">
      ...
      <div
        className="border bg-slate-500 p-3 flex justify-between  text-white rounded-b-lg shadow-lg"
        style={{
          background: resume?.attributes?.themeColor,
        }}>
        <h2 className="text-sm text-white z-10">{resume?.attributes.title}</h2>
